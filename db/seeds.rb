...
video_one_armed = Video.create!(title: "ONE ARM HANDSTAND 3 BEST EXERCISES", rating: 0, difficulty: "Advanced",
...
# videos and interactions
video_wide_grip_pushup = Video.create!(title: "How To Do A WIDE GRIP PUSH UP | Exercise Demonstration Video and Guide", rating: 0, difficulty: "Intermediate",
...
video_wide_grip_pushup1 = Video.create!(title: "Perfect Push Up Workout - Push Up (Wide)", rating: 0, difficulty: "Beginner",
...
video_wide_grip_pushup2 = Video.create!(title: "Best Push Up Workout: Chest & Abs", rating: 0, difficulty: "Intermediate",
