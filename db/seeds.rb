...
video_one_armed1 = Video.create!(title: "Yoga one-handed handstand (at the wall)", rating: 0, difficulty: "Advanced",
  user_id: gabriel.id, drill: false, tutorial: true, sub_category_id: one_armed.id, you_tube_key: "eXRrcSIE7G4")
...
video_one_armed2 = Video.create!(title: "How to do a One-Handed Handstand", rating: 0, difficulty: "Advanced",
  user_id: gabriel.id, drill: false, tutorial: true, sub_category_id: one_armed.id, you_tube_key: "CYWIk-mjbiM")
...
video_backflip2 = Video.create!(title: "Tuck Conditioning Drills", rating: 0, difficulty: "Intermediate",
  user_id: gabriel.id, drill: false, tutorial: true, sub_category_id: backflip.id, you_tube_key: "T_DYae728C4")
