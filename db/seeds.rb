...
video_one_armed = Video.create!(drill: true, tutorial: false, rating: 0, difficulty: "Advanced",
...
video_one_armed1 = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Advanced",
...
video_one_armed2 = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Advanced",
...
# videos and interactions
video_backflip = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Intermediate",
...
video_backflip1 = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Intermediate",
...
video_backflip2 = Video.create!(drill: true, tutorial: false, rating: 0, difficulty: "Intermediate",
...
# videos and interactions
video_wide_grip_pushup = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Intermediate",
  user_id: gabriel.id, sub_category_id: wide_grip_pushup.id, you_tube_key: "Z8nUVpSZAhE")
interaction6 = Interaction.create!(viewed_on: DateTime.now, user_id: sophie.id,
  video_id: video_wide_grip_pushup.id, viewed: true)

video_wide_grip_pushup1 = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Beginner",
  user_id: gabriel.id, sub_category_id: wide_grip_pushup.id, you_tube_key: "NJPS2d5JME0")
interaction7 = Interaction.create!(viewed_on: DateTime.now, user_id: sophie.id,
  video_id: video_wide_grip_pushup1.id, viewed: true)

video_wide_grip_pushup2 = Video.create!(drill: false, tutorial: true, rating: 0, difficulty: "Intermediate",
  user_id: gabriel.id, sub_category_id: wide_grip_pushup.id, you_tube_key: "d4lT37mRRPM")
