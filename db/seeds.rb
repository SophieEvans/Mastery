...
video_one_armed = Video.create!(title:"video_one_armed", drill: true, tutorial: false, rating: 0, difficulty: "Advanced",
...
video_one_armed1 = Video.create!(title:"video_one_armed1", drill: false, tutorial: true, rating: 0, difficulty: "Advanced",
...
video_one_armed2 = Video.create!(title:"video_one_armed2",drill: false, tutorial: true, rating: 0, difficulty: "Advanced",
...
# videos and interactions
video_backflip = Video.create!(title:"video_backflip", drill: false, tutorial: true, rating: 0, difficulty: "Intermediate",
...
video_backflip1 = Video.create!(title:"video_backflip1", drill: false, tutorial: true, rating: 0, difficulty: "Intermediate",
...
video_backflip2 = Video.create!(title:"Great Trick", drill: true, tutorial: false, rating: 0, difficulty: "Intermediate",
